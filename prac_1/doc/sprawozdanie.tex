...
Gdzie $a_n$ to wynik danej metody dla i-tej iteracji, $\alpha$ to wartość do której zbiega metoda czyli $\pi$, w tej pracy przyjmiemy że to wartość biblioteczna. Zaś $c$ to stała. Ten wzór jest równoważny innej granicy:
