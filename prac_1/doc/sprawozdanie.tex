...
Dla każdej metody eksperymentalnie szacowaliśmy rząd zbieżności i przedstawiliśmy wyniki na odpowiednich wykresach.
...
\begin{thebibliography}{69}
    \bibitem{review}
        N. D. Baruah, C. Bruce, Berndt, and Heng Huat Chan.,
